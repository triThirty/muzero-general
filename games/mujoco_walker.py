...
class MuZeroConfig:
    def __init__(self):
        ...
        # Sampled continuous action size
        self.num_of_sampled_actions = 10
        ...
        ### Game
        self.observation_shape = 24  # Dimensions of the game observation, must be 3D (channel, height, width). For a 1D array, please reshape it to (1, 1, length of array)
        self.action_space = 6  # Fixed list of all possible actions. You should only edit the length
...
class Game(AbstractGame):
    ...
    def legal_actions(self):
        ...
        """
        # TODO: Implement the legal actions sampling
        return list(range(2))
